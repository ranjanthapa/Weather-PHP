        ...
        <div class="weather-detail">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($weatherData) {
                    ...
                    echo "<p><strong>Temperature: " . $temp . " Kelvin</strong></p>";
                    echo "<p><strong>Minimum Temperature: " . $min_temp . " Kelvin</strong></p>";
                    echo "<p><strong>Maximum Temperature: " . $max_temp . " Kelvin</strong></p>";
                }
            }
            ?>
        </div>
